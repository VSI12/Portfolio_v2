    ...
    <div className={styles.certifications__cards}>
            ...
            <div className={styles.card}>
                <div className={styles.topsection}>
                    ...
                    <div className={styles.imageContainer}>
                            ...
                            width={170}
                            height={170}
                            className={styles.certifications__img}
                            />
                    </div>
                </div>
                <div className={styles.bottomsection}>
                    ...
                    <div className={styles.item}>
                        <span className={styles.bigtext}>Verify</span>
                        <span className={styles.regulartext}>with</span>
                    </div>
                    <div className={styles.item}>
                    <svg 
                        width="64"
        ...
        <div className={styles.certification}>
            ...
            <div className={styles.topsection}>
                ...
                <div data-iframe-width="150" data-iframe-height="270" data-share-badge-id="bc27d052-e7de-4c91-9568-9321f5e137c6" data-share-badge-host="https://www.credly.com"></div><script type="text/javascript" async src="//cdn.credly.com/assets/utilities/embed.js"></script>
                </div>
                </div>
            </div>
            <div className={styles.bottomsection}>
